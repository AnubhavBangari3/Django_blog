...
class HomeView(ListView):
    ...
    def get_context_data(self,*args,**kwargs):
        ...
        context["Coding"]=Category.objects.get(name="Coding")
        context["sports"]=Category.objects.get(name="sports")
        context["Entertainment"]=Category.objects.get(name="Entertainment")
        context["Nature"]=Category.objects.get(name="Nature")
        return context
